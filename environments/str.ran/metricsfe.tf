resource "vsphere_folder" "metricsfe_folder" {
  datacenter = "${var.vsphere_datacenter}"

  path = "${format("%s/METRICSFE", vsphere_folder.env_folder.path)}"
}
...
module "metricsfe" {
  ...
  #srv_number    = "01"
  env_folder = "${vsphere_folder.metricsfe_folder.path}"
