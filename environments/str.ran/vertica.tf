resource "vsphere_folder" "vertica_folder" {
  datacenter = "${var.vsphere_datacenter}"

  path = "${format("%s/VERTICA", vsphere_folder.env_folder.path)}"
}
...
module "vertica" {
  ...
  #srv_number    = "01"
  env_folder = "${vsphere_folder.vertica_folder.path}"
